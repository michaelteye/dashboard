...
const SmallCards2 = ({title,price,percent}:InfoProps) => {
  return (
    <div className="bg-white p-5 w-1/2 navbarShadow rounded-md mb-4  flex flex-col gap-y-1">
      <div className=" flex items-center justify-between mb-4">
        <div className="g-[#ffe8e5] rounded-lg p-2 w-14">
          <img src={Paypal} alt="" className='w-14 bg-[#ffe8e5] rounded-md' style={{ width: 35, height:35 }} />
        </div>
